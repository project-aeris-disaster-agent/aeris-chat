 ...
 *
 * Canonical contract lives in the dashboard repo
 * (docs/USER_PROFILE_GAMIFICATION.md). If you change rewards or the curve here,
 * change the SQL `aeris_level_from_xp` too — never one without the other.
 */
...
/** Default points per action. Keep in sync with the dashboard contract. */
